...
const TicTacToe = () => {
  ...
  interface CheckWinnerProps {
    ...
    setGameState: React.Dispatch<React.SetStateAction<typeof GameState[keyof typeof GameState]>>
  }
  const checkWinner = ({tiles, setStrikeClass, setGameState} : CheckWinnerProps) => {
  ...
  return (
    ...
    <div className="tic-body tic-text">
